...
API_ENDPOINT = os.getenv("API_ENDPOINT", "http://localhost:8000/api/forecast-demo")
...
def buffer_data(data):
    ...
    # Milestone 7: ML Data Buffered (65% progress)
    req_info = load_id()
    if req_info:
        ...
        report_progress(
            ...
            customer_id=cust_id,
            progress_percent=65,
            stage_name="ml_data_buffered",
            message="Machine learning training and inference data successfully buffered.",
            status="running"
        )
